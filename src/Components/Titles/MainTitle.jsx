...
export function MainTitle({title, anchor}) {
    ...
    return <div className="appearFromRight text-center font-designer pt-5 pb-2 md:text-start lg:mb-8 lg:mt-8 flex flex-row justify-center text-transparent bg-clip-text bg-gradient-to-br to-blue-900 from-gray-500"
                id={anchor}>
