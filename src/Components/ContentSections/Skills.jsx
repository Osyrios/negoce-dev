...
export function Skills(){
    ...
    return <div className="mx-7 mt-6">
        <div className="appearFromLeft text-center font-robotoBold underline animate-pulse text-red-600  hover:scale-110">
        ...
        <div className="appearFromBottom pt-5 flex flex-col items-center">
            ...
            <div className="grid grid-cols-4 gap-3 place-items-center mb-5 pt-2">
                ...
                <img src={tailwindcssLogo} alt="Logo TailwindCss" className={logoStyle + 'col-span-2'}/>
            </div>
        </div>
