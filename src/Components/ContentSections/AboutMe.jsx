    ...
    return <>
        <div className=" flex flex-col justify-center items-center gap-5 mt-5 mb-16 mx-7 md:mx-0 md:justify-start md:gap-9 md:mt-16 md:mb-32 lg:flex-row xl:gap-32 font-robotoRegular">
                <img src={photoYassine}
                     ...
                     className="appearFromRight ellip rounded-full mt-4 h-1/3 w-1/3 text-center md:h-2/6 md:w-2/6 lg:h-2/5 lg:w-2/5 xl:h-1/5 xl:w-1/5 xl:ms-10 border-4 border-titles-secondary"
                />
            <div className="appearFromBottom flex flex-col items-center xl:w-1/2">
                    ...
                    <div className="py-2 text-justify text-sm">
                        ...
                        <p className="pb-3">
                            Après 8 ans en tant que comptable, il est temps pour moi de quitter ce milieu pour le monde du développement.
                        </p>

                        <p className="pb-3">
                            Mi-2022, j&apos;ai entamé mon aventure dans la reconversion professionnelle afin de pouvoir enfin lier travail et passion !
                        </p>
