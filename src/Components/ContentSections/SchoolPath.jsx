...
export function SchoolPath()  {
    ...
    return <div className="appearFromLeft flex flex-col sm:items-center lg:flex-row lg:items-start lg:justify-evenly font-robotoRegular">
            {degrees.map((degree)=>
                <div key={degree.degree} className="customCards mx-9 my-10 p-0.5 bg-white hover:scale-105 transition ease-in-out delay-75 duration-200 sm:flex sm:flex-row sm:items-center sm:gap-7 lg:mx-2">
